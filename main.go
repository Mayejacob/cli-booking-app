...
func main() {
	...
	// validation
	isValidName, isEmailValid, isValidTicketNumber := helper.ValidateInput(firstName, lastName, email, userTickets, remainingTickets)
	if isValidName && isEmailValid && isValidTicketNumber {
		...
		fmt.Printf("TThe first names of our bookings: %v\n", firstNames)
